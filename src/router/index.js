...

  {
    ...
    children: [
      ...
      },
      {
        path: 'depart',
        name: '部门管理',
        component: () => import('@/views/sys/depart/index'),
      ...
      },
      {
        ...
        meta: { title: '参数管理', icon: 'user' }
      },
      {
        path: 'industry',
        name: '行业管理',
        component: () => import('@/views/sys/industry/index'),
        meta: { title: '行业管理', icon: 'user' }
      },
      {
        path: 'enterprise',
        name: '企业管理',
        component: () => import('@/views/sys/enterprise/index'),
        meta: { title: '企业管理', icon: 'user' }
      },
      {
        path: 'button',
        name: '按钮管理',
        component: () => import('@/views/sys/button/index'),
        meta: { title: '按钮管理', icon: 'user' }
      },
      {
        path: 'menu',
        name: '菜单管理',
